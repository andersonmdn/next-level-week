...
const Points = () => {
	...
	const [initailPosition, setInitailPosition] = useState<[number, number]>([0, 0]);
			...
			<View style={styles.container}>
				...
				<View style={styles.mapContainer}>
					{initailPosition[0] !== 0 && (
						<MapView
							style={styles.map}
							loadingEnabled={initailPosition[0] === 0}
							initialRegion={{
								latitude: initailPosition[0],
								longitude: initailPosition[1],
								latitudeDelta: 0.014,
